  ...
  return (
    <div className="todo__list">
      {props.todos.map((todo) => (
        <div className={`todo__list-item ${todo.completed ? 'todo__list-item--completed' : ''}`}>
          <div onClick={() => props.selectTodo(todo.id)} className="todo__list-item-check"></div>
          <p>{todo.text}</p>
          <div className="tasks__items-row-actions">
            <div onClick={() => props.editTodo(todo.id, todo.text)}>
              <svg
                width="15"
                height="15"
                viewBox="0 0 15 15"
          ...
          <div onClick={props.deleteTodo.bind(null, todo.id)} className="todo__list-item-remove">
            <svg
              width="11"
              height="11"
              viewBox="0 0 11 11"
